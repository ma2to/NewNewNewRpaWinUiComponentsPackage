...
/// <summary>
/// Public interface for Environment Configuration operations.
...
{
    /// <summary>
    /// Registers environment configurations from builder.
    /// This is typically called at application startup to register all environments.
    /// </summary>
    /// <param name="environments">List of environment configurations from builder</param>
    /// <param name="cancellationToken">Cancellation token for the operation</param>
    /// <returns>Result of the operation</returns>
    Task<PublicResult> RegisterEnvironmentsAsync(
    ...
    /// <param name="cancellationToken">Cancellation token for the operation</param>
    /// <returns>Result with the loaded environment configuration</returns>
    Task<PublicResult<PublicEnvironmentConfig>> LoadEnvironmentConfigAsync(
    ...
    /// <param name="cancellationToken">Cancellation token for the operation</param>
    /// <returns>Result with the loaded environment configuration</returns>
    Task<PublicResult<PublicEnvironmentConfig>> DetectAndLoadEnvironmentAsync(
    ...
    /// <param name="cancellationToken">Cancellation token for the operation</param>
    /// <returns>Result of the operation</returns>
    Task<PublicResult> ExportEnvironmentConfigAsync(
        string environmentName,
        string filePath,
        CancellationToken cancellationToken = default);
    ...
    /// <param name="environmentName">Name of the environment to export</param>
    /// <param name="cancellationToken">Cancellation token for the operation</param>
    /// <returns>Result with JSON string representation of the environment config</returns>
    Task<PublicResult<string>> ExportEnvironmentConfigAsJsonAsync(
        string environmentName,
        CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">Cancellation token for the operation</param>
    /// <returns>Result with the imported environment configuration</returns>
    Task<PublicResult<PublicEnvironmentConfig>> ImportEnvironmentConfigAsync(
        string filePath,
        CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">Cancellation token for the operation</param>
    /// <returns>Result with the imported environment configuration</returns>
    Task<PublicResult<PublicEnvironmentConfig>> ImportEnvironmentConfigFromJsonAsync(
        string jsonConfig,
        CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">Cancellation token for the operation</param>
    /// <returns>Result of the operation</returns>
    Task<PublicResult> SetActiveEnvironmentAsync(
        string environmentName,
        CancellationToken cancellationToken = default);
    ...
    /// </summary>
    /// <param name="cancellationToken">Cancellation token for the operation</param>
    /// <returns>Result with the active environment configuration, or null if no active environment is set</returns>
    Task<PublicResult<PublicEnvironmentConfig?>> LoadActiveEnvironmentAsync(
        CancellationToken cancellationToken = default);
    ...
    PublicEnvironmentConfig? GetActiveEnvironment();
    ...
    /// <returns>Setting value, or default(T) if not found or no active environment</returns>
