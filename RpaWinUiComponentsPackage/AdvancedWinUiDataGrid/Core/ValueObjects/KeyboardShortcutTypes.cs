...
/// <summary>
/// CORE VALUE OBJECT: Keyboard shortcut definition
/// </summary>
...
/// <summary>
/// CORE VALUE OBJECT: Keyboard shortcut configuration
/// </summary>
internal sealed class KeyboardShortcutConfiguration
{
...
/// <summary>
/// CORE VALUE OBJECT: Keyboard navigation result
/// </summary>
internal sealed record KeyboardNavigationResult
{
    ...
    public static KeyboardNavigationResult CreateHandled(string action, int? newRow = null, int? newColumn = null) =>
...
/// <summary>
/// CORE VALUE OBJECT: Keyboard shortcut result
/// </summary>
internal sealed record KeyboardShortcutResult
{
    ...
    public static KeyboardShortcutResult CreateSuccess(string action, TimeSpan executionTime = default) =>
        new() { Success = true, Action = action, ExecutionTime = executionTime };

    public static KeyboardShortcutResult Failure(string errorMessage) =>
