...
/// <summary>
/// CORE VALUE OBJECT: Virtualization configuration for large datasets
/// </summary>
internal sealed record VirtualizationConfiguration
{
...
/// <summary>
/// CORE VALUE OBJECT: Performance statistics for monitoring
/// </summary>
...
/// <summary>
/// CORE VALUE OBJECT: Data page for virtualization
/// </summary>
internal sealed record DataPage
{
...
/// <summary>
/// CORE VALUE OBJECT: Progress information for large data operations
/// </summary>
internal sealed record LargeDataProgress
{
...
/// <summary>
/// CORE VALUE OBJECT: Performance metrics for monitoring and telemetry
/// </summary>
internal sealed record PerformanceMetrics
{
    ...
    public PerformanceStatistics? VirtualizationStats { get; init; }

    public static PerformanceMetrics Create(
        long totalOps,
        TimeSpan totalTime,
        double memoryUsage,
        PerformanceStatistics? virtualizationStats = null) =>
        new()
        {
            TotalOperations = totalOps,
            TotalTime = totalTime,
            AverageOperationTime = totalOps > 0 ? totalTime.TotalMilliseconds / totalOps : 0,
            OperationsPerSecond = totalTime.TotalSeconds > 0 ? totalOps / totalTime.TotalSeconds : 0,
            MemoryUsageMB = memoryUsage,
