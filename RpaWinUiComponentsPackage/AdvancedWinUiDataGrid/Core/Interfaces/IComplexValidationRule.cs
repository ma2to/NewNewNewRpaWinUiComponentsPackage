...
/// <summary>
/// PUBLIC API: Complex validation rule for cross-row and cross-column validation
...
/// <summary>
/// PUBLIC API: Cross-row validation rule for multiple row validation
...
/// <summary>
/// PUBLIC API: Cross-column validation rule for same row validation
...
/// <summary>
/// PUBLIC API: Conditional validation rule - validates only if condition is met
