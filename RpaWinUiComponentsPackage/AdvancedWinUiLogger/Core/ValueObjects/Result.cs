...
/// ENTERPRISE: Monadic operations for clean error propagation
/// </summary>
public readonly struct Result<T>
{
    ...
    public string Error => _errorMessage ?? "Unknown error";
...
/// <summary>
/// FUNCTIONAL: Non-generic Result for operations that don't return values
/// </summary>
public readonly struct Result
{
    ...
    private Result(string? errorMessage, Exception? exception, bool isSuccess)
    {
        _errorMessage = errorMessage;
        _exception = exception;
        _isSuccess = isSuccess;
    ...
    /// <summary>FUNCTIONAL: Create failure result with message</summary>
    public static Result Failure(string errorMessage) => new(errorMessage, null, false);

    /// <summary>FUNCTIONAL: Create failure result with message and exception</summary>
    public static Result Failure(string errorMessage, Exception exception) =>
        new(errorMessage, exception, false);

    /// <summary>FUNCTIONAL: Create failure result from exception</summary>
    public static Result Failure(Exception exception) =>
        new(exception.Message, exception, false);
    ...
    public override string ToString() => _isSuccess ? "Success" : $"Failure: {_errorMessage}";
}
